...
public class MotherShip implements Runnable {
	...
	public MotherShip() {
		 ...
		 * check your work
		 */
		nodeOneBTURL = "btspp://000666D0E48B:1;authenticate=true;" + "encrypt=true;master=false";
		nodeTwoBTURL = "btspp://000666D0E8C4:1;authenticate=true;" + "encrypt=true;master=false";
		nodeThreeBTURL = "btspp://000666D0E433:1;authenticate=true;" + "encrypt=true;master=false";
	 ...
	 * 
	 *            For each provided node an object is created in a JSON array
	 *
	 * @return a json array as a string ready to be sent to the server
	 */
	private String formatData(ArrayList<Node> nodes) {

		JSONArray arrayOfNodes = new JSONArray();

		for (Node node : nodes) {
			arrayOfNodes.put(node.getData());
		}
	 ...
	 *
	 * @param jsonString
	 *            a string formatted and ready to be sent to the server
	 */
